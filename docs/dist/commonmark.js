"use strict";(()=>{var we=Object.create;var W=Object.defineProperty;var ge=Object.getOwnPropertyDescriptor;var Le=Object.getOwnPropertyNames;var Ee=Object.getPrototypeOf,ze=Object.prototype.hasOwnProperty;var G=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports);var Te=(e,n,o,t)=>{if(n&&typeof n=="object"||typeof n=="function")for(let a of Le(n))!ze.call(e,a)&&a!==o&&W(e,a,{get:()=>n[a],enumerable:!(t=ge(n,a))||t.enumerable});return e};var J=(e,n,o)=>(o=e!=null?we(Ee(e)):{},Te(n||!e||!e.__esModule?W(o,"default",{value:e,enumerable:!0}):o,e));var V=G(g=>{"use strict";Object.defineProperty(g,"__esModule",{value:!0});g.StyledElement=g.CustomElement=void 0;var y=class extends HTMLElement{constructor(){super(),this.root=this.attachShadow({mode:"open"}),this.connected=!1}connectedCallback(){this.connected||(this.connect(),this.connected=!0)}};g.CustomElement=y;var R=class extends y{constructor(n){super();let o=document.createElement("link");o.setAttribute("rel","stylesheet");let t=document.currentScript.src,a=t.substring(0,t.lastIndexOf("/"));o.setAttribute("href",`${a}/${n}.css`),this.root.appendChild(o),this.body=document.createElement("div"),this.root.appendChild(this.body)}};g.StyledElement=R});var ue=G((pn,en)=>{en.exports=[{markdown:`	foo	baz		bim
...
`,html:"<p>Multiple     spaces</p>",example:652,start_line:9411,end_line:9415,section:"Textual content"}]});var Z=J(V());function i(e,...n){let o=document.createElement(e);return n.length>0&&o.append(...n),o}function m(e){return document.createTextNode(e)}function I(e){let n=[],o=/\s/g,t=0,a;for(;a=o.exec(e);){t<a.index&&n.push(m(e.substring(t,a.index))),t=a.index+a[0].length;let l=i("span",m(qe(a[0])));l.className="ws",n.push(l)}return t<e.length&&n.push(m(e.slice(t))),n}function qe(e){let n;switch(e){case"	":return"\u2192";case`
`:return`\u21A9
`;case" ":return"\xB7";default:return e}}function Fe(e,n,o,t){if(e.find(l=>l.target==o))throw new Error("Transition between source and target already exist");let a={regexp:new RegExp(n,"yui"),target:o,group:t};return e.push(a),a}var w=class e{states;start;accept;groups;current;constructor(n,o,t){this.states=n,this.start=o,this.accept=t,this.groups={},this.current=this.start}static create(n,o){let t=Array.from({length:n+2},()=>[]);if(o.length!=t.length)throw new Error("Wrong number of arguments for the init function");let a=o(...t),l=t[0],s=t[t.length-1];for(let r=0;r<a.length;++r){let[d,_,F,v]=a[r];Fe(d,_,F,v)}if(s.length>0)throw new Error("Accept state cannot have outgoing transitions");return new e(t,l,s)}init(){this.current=this.start,this.groups={}}clone(){let n=structuredClone(this);return new e(n.states,n.start,n.accept)}exec(n,o,t=!1){let a=this.current;if(a==this.accept||!t&&o>=n.length)return[!0,o];for(let l=0;l<a.length;++l){let s=a[l];s.regexp.lastIndex=o;let r=s.regexp.exec(n);if(r){if(s.group){let _=r[0];r.index+_.length>=n.length&&(_+=`
`),this.groups[s.group]?this.groups[s.group]+=_:this.groups[s.group]=_}this.current=s.target;let d=this.exec(n,r.index+r[0].length,t);if(d[0])return d}}return[!1,o]}get accepted(){return this.current==this.accept}static concat(...n){let o=n[0].clone(),t=o;for(let a=1;a<n.length;++a){let l=a==n.length-1?n[a]:n[a].clone(),s=t.incoming(t.accept);for(let r=0;r<s.length;++r)s[r].target=l.start;o.states.pop(),o.states.push(...l.states),t=l}return o.accept=t.accept,o}getRegExp(n){return n.map(o=>`(?:${o.regexp.source})`).join("|")}get startRegExp(){return this.getRegExp(this.start)}incoming(n){let o=[];for(let t=0;t<this.states.length;++t){let a=this.states[t];if(a!=n)for(let l=0;l<a.length;++l){let s=a[l];s.target==n&&o.push(s)}}return o}};function p(e,n){return{matched:e,regexp:n}}function T(e,n,o=0){return{input:n,nextIndex:o,blocks:e.blocks,linkRefs:e.linkRefs,links:e.links}}function c(e,n,o,t=!0,a=n,l,s,r){e.blocks.push({element:n,parent:a,type:o,leaf:t,lines:[],cont:l,closing:s,continuing:r})}function x(e){let o=e.blocks.pop().element,t=h(e)?.parent;t&&t!=o&&t.append(o)}function h(e){return e.blocks[e.blocks.length-1]}function B(e){return h(e).element.tagName=="P"}function A(e){b(e),B(e)&&x(e)}function f(e,...n){h(e).parent.append(...n)}function S(e,n){h(e).parent.insertAdjacentHTML("beforeend",n)}function ye(e,n){n.lines.push(e.input.slice(e.nextIndex)),e.nextIndex=e.input.length}function pe(e,n){for(;n.lines.length>0&&n.lines[n.lines.length-1]=="";)n.lines.pop();for(;n.lines.length>0&&n.lines[0]=="";)n.lines.shift()}function de(e,n){let o=e.map((t,a)=>`(?<g${a}>${t.regexp})`).join("|");return new RegExp(o,n?"yuis":"guis")}function Ie(e,n){return new RegExp(`(?<open>${e})|(?<close>${n})`,"guis")}function L(e,n){n.lastIndex=e.nextIndex;let o=n.exec(e.input);return o&&(e.nextIndex=o.index+o[0].length),o}function ce(e,n,o,t){if(o.nextIndex>=o.input.length)return!1;e.lastIndex=o.nextIndex;let a=e.exec(o.input);if(a&&a.groups){let l=n.find((s,r)=>a.groups[`g${r}`]!=null);if(l)return t&&_e(o,a.index),o.nextIndex=a.index+a[0].length,l.matched(o,a),!0}return!1}var he=/\\(?<esc>[!"#$%&'()*+,\-./:;<=>?@\[\\\]^_`{|}~\n])/guis,Ae=/(?<entity>&(?:[a-z]\w*|#\d{1,7}|#[Xx][\da-f]{1,6});)/.source,Be=/ {4}| {0,3}\t/yuis,Se=/ {4}| {0,3}\t|\s*$/yuis,Y=/ {0,3}> ?/yuis,E=/(?=\s*\S)/yuis,He=/(?<codedelim>`+)(?<code>\s.+\s|(?:[^`]|(?!\k<codedelim>)`)+)\k<codedelim>/.source,Me=/(?<emdelim>(?:(?<!\\)|(?<=\\\\))(?:\*\*?(?![\s\p{P}\p{S}]|$))|(?:(?<=[\s\p{P}\p{S}]|^)\*\*?(?![\P{P}*])))(?<em>.+?)(?:(?<![\s\p{P}\p{S}\\*])\k<emdelim>(?!\*)|(?<![\P{P}\\*])\k<emdelim>(?=[\s\p{P}\p{S}])|(?<![\s\\*])\k<emdelim>$)/u.source,ve=/(?<emdelim>(?:(?<!\\)|(?<=\\\\))(?:__?(?![\s\p{P}\p{S}]|$))|(?:(?<=[\s\p{P}\p{S}]|^)__?(?![\P{P}_])))(?<em>.+?)(?:(?<![\s\p{P}\p{S}\\_])\k<emdelim>(?!_)|(?<![\P{P}\\_])\k<emdelim>(?=[\s\p{P}\p{S}])|(?<![\s\\_])\k<emdelim>$)/u.source,Re=/\[(?<linklabel>(?:\s*(?:[^\[\]\s]|(?<=\\)(?<!\\\\)[\[\]])+\s*)+)\]/.source,Pe=/(?:(?<!\\)<(?<linkdest>(?:[^<>\n]|(?<=\\)[<>])*)(?<!\\)>|(?<linkdest>(?!<)(?:[^\x00-\x1F\x7F ()]|(?<=\\)[()])*))/.source,$e=/(?:"(?<linktitle>(?:[^"]|(?<=\\)")+)"|'(?<linktitle>(?:[^']|(?<=\\)')+)'|\((?<linktitle>(?:[^()]|(?<=\\)[()])+)\))/.source,Ce=/(?<!\\)\[/.source,De=/(?<!\\)!\[/.source,Ne=/(?<!\\)!?\[/.source,je=/(?:(?<!\\)|(?<=\\\\))\]/.source,K=Ie(Ne,je),Q=new RegExp(`\\(\\s*${Pe}(?:\\s+${$e})?\\s*\\)`,"yuis"),ee=new RegExp(Re,"yuis"),ne=/(?![(:])(?:\[\])?/yuis,Oe=/<(?<autolink>[a-z][\w\-+.]{1,31}:[^\x00-\x1F\x7F <>]*)>/.source,Xe=/<(?<email>[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)>/.source,Ze=/(?<tagstart><(?<tag>[a-z][a-z0-9\-]*)(?:\s+[a-z:_][\w.:\-]*\s*(?:=\s*"[^"]*"|=\s*'[^']*'|=[^\s"'=<>`]+)?)*\s*)(?<tagend>\/?>)(?:(?<innerhtml>.*)<\/\k<tag>\s*>)?/.source,Ue=w.create(1,(e,n,o)=>[[e,/ {0,3}\[/,n],[n,/\s*(?:[^\[\]\s]|(?<=\\)(?<!\\\\)[\[\]])+/,n,"label"],[n,/\s*(?:(?<!\\)|(?<=\\\\))\]:\s*/,o]]),We=w.create(0,(e,n)=>[[e,/\s*(?:<(?:[^<>]|(?<=\\)[<>])+(?<!\\)>|(?<!<)(?:[^\x00-\x1F\x7F ()]|(?<=\\)[()])+)(?:\s+|$)/,n,"dest"]]),Ge=w.create(3,(e,n,o,t,a)=>[[e,/\s*"/,n],[n,/(?:\s*(?:[^"\s]|(?<=\\)")+)+/,n,"title"],[n,/(?<!\\)"\s*$/,a],[e,/\s*'/,o],[o,/(?:\s*(?:[^'\s]|(?<=\\)')+)+/,o,"title"],[o,/(?<!\\)'\s*$/,a],[e,/\s*\(/,t],[t,/(?:\s*(?:[^()]|(?<=\\)[()])+)+/,t,"title"],[t,/(?<!\\)\)\s*$/,a],[e,/(?!["'(])|^/,a]]),u=w.concat(Ue,We,Ge);function _e(e,n){if(n==null||n>e.nextIndex){let o=e.input.substring(e.nextIndex,n);o&&f(e,m(o))}}function H(e,n,o,t){o.lastIndex=n;let a=o.exec(e);if(a){let{open:l,close:s}=a.groups;if(n=a.index+a[0].length,l&&l==t){let r=H(e,n,o,t);return r?H(e,r.index+r[0].length,o,t):void 0}else if(s)return a}}function oe(e){return p((n,o)=>{let{emdelim:t,em:a}=o.groups;c(n,i(t.length==1?"em":"strong"),1),q(T(n,a)),x(n)},e)}function $(e,n,o,t){let a=i("a");return o&&(a.href=z(o)),t&&(a.title=z(t)),c(e,a,1),q(T(e,n)),x(e),a}function te(e,n,o){n=n.toUpperCase();let t=e.linkRefs[n];if(t)$(e,o,t.destination,t.title);else{let a=e.links[n]||[];a.push($(e,o)),e.links[n]=a}}function C(e,n,o,t){let a=i("img");return o&&(a.src=z(o)),a.alt=n,t&&(a.title=t),f(e,a),a}function ae(e,n,o){n=n.toUpperCase();let t=e.linkRefs[n];if(t)C(e,o,t.destination,t.title);else{let a=e.links[n]||[];a.push(C(e,o)),e.links[n]=a}}function z(e){return e?.replaceAll(he,n=>n[1])}var le=[p((e,n)=>{let{esc:o}=n.groups;o==`
`&&f(e,i("br")),f(e,m(o))},he.source),p((e,n)=>{let{entity:o}=n.groups;S(e,o)},Ae),p((e,n)=>{let{code:o}=n.groups;o=o.replaceAll(`
`," ");let t=/^ (.*[^ ].*) $/.exec(o);t&&(o=t[1]),f(e,i("code",m(o)))},He),p((e,n)=>{let o=H(e.input,e.nextIndex,K,"![");if(o){let t=e.input.substring(e.nextIndex,o.index);switch(e.nextIndex=o.index+o[0].length,e.input[e.nextIndex]){case"(":let a=L(e,Q);if(a){let{linkdest:r,linktitle:d}=a.groups;return $(e,t,r,d)}break;case"[":let l=L(e,ee);if(l){let{linklabel:r}=l.groups;return te(e,r,t)}default:if(L(e,ne))return te(e,t,t)}e.nextIndex=n.index+n[0].length}f(e,m(n[0]))},Ce),p((e,n)=>{let o=H(e.input,e.nextIndex,K,"[");if(o){let t=e.input.substring(e.nextIndex,o.index);switch(e.nextIndex=o.index+o[0].length,e.input[e.nextIndex]){case"(":let a=L(e,Q);if(a){let{linkdest:r,linktitle:d}=a.groups;return C(e,t,r,d)}break;case"[":let l=L(e,ee);if(l){let{linklabel:r}=l.groups;return ae(e,r,t)}default:if(L(e,ne))return ae(e,t,t)}e.nextIndex=n.index+n[0].length}f(e,m(n[0]))},De),p((e,n)=>{let{autolink:o}=n.groups,t=i("a",m(o));t.href=o,f(e,t)},Oe),p((e,n)=>{let{email:o}=n.groups,t=i("a",m(o));t.href="mailto:"+o,f(e,t)},Xe),oe(Me),oe(ve),p((e,n)=>{let{tagstart:o,tagend:t,innerhtml:a}=n.groups;S(e,o+t),t==">"&&a&&(c(e,h(e).parent.lastElementChild,1),q(T(e,a)),x(e))},Ze)],P;function q(e){if(!/^\s*$/.test(e.input)){for(P=P||de(le,!1);ce(P,le,e,!0););_e(e)}}function ie(e,n,o,t){let a=n[0],l=n.index+a.length>=e.input.length?"":"|\\s*$",s=e.blocks.length-1;if(e.blocks[s].element.tagName=="P"){let k=e.blocks[s-1];if(k.element.tagName!="LI"&&(l.length==0||t&&t!="1")){e.nextIndex=n.index;return}b(e),k.element.tagName=="LI"?re(e,k):x(e)}let d=a.length,_=o.length;_==0?d++:(_>4||l.length==0)&&(d-=_-1);let F=h(e),v=a.replaceAll(/\d+|[+*.)]|\s+$/g,k=>k[0]==" "?`(?:${k}|$)`:Number.isFinite(Number(k))?"\\d{1,9}":"\\"+k),U=new RegExp(`(?= {${d}}${l}|${v})`,"yui");if(t&&F.element.tagName!="OL"){let k=i("ol");t!="1"&&(k.start=Number.parseInt(t)),c(e,k,1,!1,void 0,U,se)}else!t&&F.element.tagName!="UL"&&c(e,i("ul"),1,!1,void 0,U,se);c(e,i("li"),1,!1,void 0,new RegExp(` {${d}}${l}`,"yui"),re),e.nextIndex=n.index+d}function re(e,n){let o=h(e),t=e.blocks[e.blocks.length-2];if(n.lines.length==0&&n==t&&n.element.childElementCount==0&&o.element.tagName=="P"){let a=e.blocks.pop();f(e,...a.element.childNodes),n.lines=a.lines}else if(n==o&&!t.closing&&n.element.childElementCount==1&&n.element.firstElementChild.tagName=="P"){let a=n.element.firstElementChild;n.element.append(...a.childNodes),a.remove()}}function se(e,n){n.element.querySelector(":scope > li > p")||(n.closing=void 0)}function Je(e,n){pe(e,n);let o=/ {0,3}(?:`|~){3,}\s*$/yiu;o.lastIndex=e.nextIndex,o.exec(e.input)&&(e.nextIndex=o.lastIndex)}function Ve(e,n){let[o,t]=u.exec(e.input,e.nextIndex);!o||u.accepted?(D(e,n),e.nextIndex=t):e.nextIndex=e.input.length}function Ye(e,n){u.exec(e.input,e.nextIndex,!0),D(e,n)}function D(e,n){if(u.accepted){let{label:o,dest:t,title:a}=u.groups;if(o&&t){o=o.trim().toUpperCase(),t=z(t.trim()),a=z(a),e.linkRefs[o]||(/^<.*>$/.test(t)&&(t=t.slice(1,t.length-1)),e.linkRefs[o]={destination:t,title:a},e.links[o]?.forEach(l=>{t&&(l instanceof HTMLAnchorElement?l.href=t:l.src=t),a&&(l.title=a)}),delete e.links[o]),x(e);return}}n.element=i("p"),n.parent=n.element,n.type=1,n.cont=E}function me(e){B(e)||(b(e),c(e,i("p"),1,!0,void 0,E))}var fe=[p((e,n)=>{let{setext:o,setextspaces:t}=n.groups,a=h(e),l=n[0].trim().length;a.element.tagName=="P"?(a.element=i(o=="="?"h1":"h2"),a.parent=a.element,b(e),x(e)):o=="-"&&l>2?(b(e),f(e,i("hr"))):o=="-"&&l==1?ie(e,n,t):(c(e,i("p"),1,!0,void 0,E),f(e,m(n[0])))},/ {0,3}(?<setext>-|=)\k<setext>*(?<setextspaces>\s*)$/.source),p(e=>{A(e),f(e,i("hr"))},/ {0,3}(?<brkchar>[*\-_])(?:\s*\k<brkchar>){2,}\s*$/.source),p((e,n)=>{A(e);let{atxlevel:o,atxheader:t}=n.groups,a=o.length;c(e,i(`h${a}`),1),q(T(e,t)),x(e)},/ {0,3}(?<atxlevel>#{1,6})\s+(?<atxheader>.*?)\s*$/.source),p(e=>{if(!B(e)){b(e);let n=i("code");c(e,i("pre",n),0,!0,n,Se,pe)}},Be.source),p((e,n)=>{let{codefence:o,codelang:t}=n.groups;A(e);let a=new RegExp(`(?! {0,3}${o}+\\s*$)`,"yui"),l=i("code");t&&(l.className=`language-${z(t)}`),c(e,i("pre",l),0,!0,l,a,Je)},/ {0,3}(?<codefence>(?:`|~){3,})(?:\s*(?<codelang>[^\s`~]+))?\s*$/.source),p(e=>{b(e);let n=/(?!.*(?:<\/pre>|<\/script>|<\/style>|<\/textarea>))/yui,o=e.input;n.lastIndex=e.nextIndex,n.test(o)?c(e,h(e).parent,2,!0,void 0,n,ye):(S(e,o.slice(e.nextIndex)+`
`),e.nextIndex=o.length)},/(?= {0,3}<pre|<script|<style|<textarea)/.source),p(e=>{b(e),c(e,h(e).parent,2,!0,void 0,E)},/(?= {0,3}<[a-z][a-z0-9\-]*(?:\s+[a-z:_][\w.:-]*\s*(?:=\s*"[^"]*"|\s*='[^']*'|=[^\s"'=<>`]+)?)*\s*>\s*$)/.source),p(e=>{A(e),c(e,i("blockquote"),1,!1,void 0,Y)},Y.source),p((e,n)=>{let{bulletno:o,bulletsep:t}=n.groups;ie(e,n,t,o)},/ {0,3}(?:[\-+*]|(?<bulletno>\d{1,9})[.)])(?<bulletsep> +|$)/.source),p((e,n)=>{if(!B(e)){u.init();let[o]=u.exec(e.input,n.index);if(o){if(b(e),c(e,h(e).parent,3,!0,void 0,E,Ye,Ve),u.accepted)return e.nextIndex=e.input.length,D(e,h(e))}else me(e)}e.nextIndex=n.index},u.startRegExp),p(me,E.source)],Ke=de(fe,!0);function b(e){let n=h(e);if(n.lines.length>0){switch(n.type){case 1:q(T(e,n.lines.map(o=>o.trim()).join(`
`)));break;case 0:f(e,m(n.lines.join(`
`)));break;case 2:n.lines.push(""),S(e,n.lines.join(`
`));break}n.lines=[]}}function ke(e,n){for(let o=n;o<e.blocks.length;++o){let t=e.blocks[o];t.closing?.(e,t)}for(;e.blocks.length>n;)b(e),x(e)}function Qe(e){for(let n=0;n<e.blocks.length;++n){let o=e.blocks[n];if(o.cont){if(o.cont.lastIndex=e.nextIndex,!o.cont.exec(e.input))return ke(e,n);e.nextIndex=o.cont.lastIndex,o.continuing?.(e,o)}}}function be(e,n){let o={input:"",nextIndex:0,blocks:[],linkRefs:{},links:{}};c(o,n,1,!1);let t=e.split(`
`);for(let a=0;a<t.length;++a){let l=t[a],s=T(o,l,0);Qe(s);let r=h(s);if(!r.leaf||r.element.tagName=="P")for(;ce(Ke,fe,s,!1)&&(r=h(s),!r.leaf););r.lines.push(l.slice(s.nextIndex))}ke(o,0)}var nn=Promise.resolve().then(()=>J(ue())),N,j=0,M=0,xe=0,O=class extends Z.StyledElement{static get observedAttributes(){return["examples"]}constructor(){super("commonmark")}connect(){this.runExamples()}get examples(){let n=[],o=this.getAttribute("examples");if(o){let t=/\s*(?<sep>[,\-])?\s*(?<num>\d+)/g,a,l;for(;l=t.exec(o);){let{sep:s,num:r}=l.groups,d=Number.parseInt(r);if(a&&s=="-")for(let _=a+1;_<d;++_)n.push(_);n.push(d),a=d}}return n}async runExamples(){N||(N=await nn),this.examples.forEach(n=>this.runTest(N[n-1]))}runTest(n){let o=0,t="<<Not run>>";try{let l=i("div"),s=window.performance.now();be(n.markdown,l),o=window.performance.now()-s,t=l.innerHTML}catch(l){l instanceof Error&&(t=l.message+`
`+l.stack)}let a=t==n.html;a?j++:M++,xe+=o,this.renderTest(n,t,a,o)}renderTest(n,o,t,a){let l=i("th",m(t?"PASS":"FAIL"));l.className=t?"pass":"fail",this.body.append(i("table",i("tr",i("th",m(`Example: ${n.example}`)),i("th",m(n.section)),l),i("tr",i("th",m("Input")),i("th",m("Expected")),i("th",m("Actual"))),i("tr",i("td",i("pre",i("code",...I(n.markdown)))),i("td",i("pre",i("code",...I(n.html)))),i("td",i("pre",i("code",...I(o))))),i("tr",i("td",m(`In ${a.toFixed(1)}ms`)))))}},X=class extends Z.StyledElement{constructor(){super("commonmark")}connect(){window.requestIdleCallback(()=>this.render())}render(){let n=j+M;this.body.append(i("table",i("tr",i("th",m("Tests Run")),i("th",m("Succeeded")),i("th",m("Failed")),i("th",m("CommonMark Coverage"))),i("tr",i("td",m(n.toString())),i("td",m(j.toString())),i("td",m(M?M.toString():"-")),i("td",m((n*100/652).toFixed(1)+"%"))),i("tr",i("td",m(`In ${xe.toFixed(1)}ms`)))))}};customElements.define("commonmark-runner",O);customElements.define("commonmark-summary",X);})();
